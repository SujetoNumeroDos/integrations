...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex items-end overflow-hidden pb-20 md:pb-28"
    >
      {/* Background */}
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#060D1F] via-transparent to-[#060D1F]/30" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.05] mb-7">
            Integramos{" "}
          ...
          <p className="text-base md:text-lg text-[#F0F4FA]/55 max-w-xl leading-relaxed mb-10">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="#servicios"
              className="bg-[#F2B800] text-[#060D1F] font-semibold px-7 py-3 text-sm hover:bg-[#F2B800]/90 transition-colors"
            >
              Nuestros servicios
            </a>
            <a
              href="#contacto"
              className="border border-white/20 text-white px-7 py-3 text-sm hover:border-white/40 transition-colors"
            >
              Solicitar propuesta
            </a>
          </div>

          {/* Stats — más discretos, en línea */}
          <div className="mt-16 flex flex-wrap gap-x-10 gap-y-4 border-t border-white/10 pt-8">
            {[
              ...
              <div key={s.label} className="flex items-baseline gap-2">
                ...
                <span className="text-xs text-[#F0F4FA]/35">{s.label}</span>
              </div>
            ))}
          </div>
        </div>
