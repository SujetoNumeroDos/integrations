...
export default function Nosotros() {
  return (
    <section id="nosotros" className="py-24 bg-white dark:bg-[#060D1F]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-14">
          <p className="text-[#F2B800] text-xs font-medium tracking-[0.2em] uppercase mb-4">Quiénes somos</p>
          <h2 className="text-3xl md:text-5xl font-bold text-[#0A1628] dark:text-white leading-tight max-w-2xl">
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          <div className="md:col-span-3 space-y-6">
            <p className="text-[#0A1628]/70 dark:text-[#F0F4FA]/70 text-lg leading-relaxed">
            ...
            <p className="text-[#0A1628]/50 dark:text-[#F0F4FA]/50 leading-relaxed">
            ...
            <a href="#contacto" className="inline-block border-b border-[#F2B800] text-[#F2B800] text-sm pb-0.5 hover:opacity-70 transition-opacity">
              Hablemos de tu proyecto →
            </a>

            <div className="pt-6 border-t border-[#0A1628]/10 dark:border-white/10 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={titulo} className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-[#0A1628] dark:text-white text-sm font-semibold">{titulo}</p>
                    <p className="text-[#0A1628]/40 dark:text-[#F0F4FA]/40 text-xs leading-relaxed mt-0.5">{desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="md:col-span-2 md:sticky md:top-24">
            <div className="relative aspect-[3/4] rounded-sm overflow-hidden">
              <img src={IMG} alt="ICHTUS Technology" className="w-full h-full object-cover" />
              ...
              <div className="absolute bottom-5 left-5">
                ...
                <p className="text-white/50 text-xs">Bogotá, Colombia</p>
              </div>
